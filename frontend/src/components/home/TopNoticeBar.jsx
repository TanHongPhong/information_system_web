    ...
    <div className="bg-gradient-to-r from-cyan-400/20 via-indigo-400/20 to-fuchsia-400/20 border-b border-white/40 backdrop-blur">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-9 flex items-center justify-between text-[13px]">
        <div className="flex items-center gap-3">
          <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-white/75 border border-white/80 text-blue-700">
      ...
      <div className="h-[3px] w-full bg-[linear-gradient(90deg,#22d3ee,#60a5fa,#a78bfa,#f472b6,#f59e0b)] bg-[length:200%_100%] animate-[shine_2.2s_linear_infinite]" />
    </div>
  );
}
