        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          <div className="animate-[fadeIn_.32s_ease-out_both]">
            ...
            <p className="mt-4 subtitle-soft text-base leading-relaxed">
              Kết nối đội xe 500kg – 2.5 tấn. Giá theo km & tải trọng rõ ràng,
              theo dõi realtime, hỗ trợ nội thành & liên tỉnh.
            </p>
            ...
            <div className="mt-6 grid grid-cols-3 gap-3 max-w-md">
              {[
                ...
                <div
                  key={x.t}
                  className="p-4 rounded-xl bg-white/80 border border-slate-200 text-center shadow-[0_12px_40px_rgba(2,6,23,.08)]"
                >
            ...
            <div className="mt-8 flex items-center gap-3">
              <Link
                ...
                className="px-5 py-3 rounded-xl bg-white text-blue-700 font-semibold border border-blue-200 hover:bg-blue-50 shadow-[0_12px_40px_rgba(2,6,23,.08)]"
              >
                Đặt xe ngay
              </Link>
              <a
                href="#pricing"
                className="px-5 py-3 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-semibold shadow-[0_10px_24px_rgba(37,99,235,.32)] btn-shine"
              >
                Xem bảng giá
              </a>
            </div>
          ...
          <div
            id="booking"
            className="glass rounded-2xl border border-white/80 p-6 lg:p-7"
          >
            ...
            <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  className="mt-1 w-full px-3 py-2 rounded-xl border border-slate-200/70 bg-white/70 focus:outline-none focus:ring-2 focus:ring-blue-200"
                  placeholder="VD: 12 Nguyễn Huệ, Q.1, HCM"
                />
              </div>
              <div>
                ...
                <input
                  className="mt-1 w-full px-3 py-2 rounded-xl border border-slate-200/70 bg-white/70 focus:outline-none focus:ring-2 focus:ring-blue-200"
                  placeholder="VD: KCN Long Thành, Đồng Nai"
                />
              </div>
              <div>
              ...
              <div>
                ...
                <input
                  placeholder="Hàng dễ vỡ / có bốc xếp"
                  className="mt-1 w-full px-3 py-2 rounded-xl border border-slate-200/70 bg-white/70 focus:outline-none focus:ring-2 focus:ring-blue-200"
                />
              </div>
            </div>
            ...
            <p className="mt-2 text-xs text-slate-500">
              Giá hiển thị trước khi đặt, có thể thay đổi theo km, tải trọng và
              dịch vụ thêm.
            </p>
          </div>
        </div>
