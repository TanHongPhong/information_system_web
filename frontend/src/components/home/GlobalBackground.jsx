  ...
  return (
    <div className="fixed inset-0 -z-50">
      ...
      <div
        ...
        style={{ background: `radial-gradient(circle at 30% 40%, var(--a1), transparent 56%),
                               radial-gradient(circle at 70% 60%, var(--a2), transparent 62%),
                               radial-gradient(circle at 50% 50%, var(--a3), transparent 68%)` }}
      />
      <div
        className="absolute -bottom-40 -right-40 w-[820px] h-[820px] rounded-full blur-3xl animate-aurora [animation-delay:3s]"
        style={{ background: `radial-gradient(circle at 40% 50%, var(--a4), transparent 60%),
                               radial-gradient(circle at 60% 50%, var(--a5), transparent 65%),
