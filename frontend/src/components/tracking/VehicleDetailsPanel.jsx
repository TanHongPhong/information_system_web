  ...
  return (
    <div className="bg-white border border-slate-200 rounded-2xl p-3">
      ...
      <div className="mt-3 flex items-start gap-3">
        ...
        <div className="text-sm leading-snug">
          ...
          <div className="text-[12px] text-slate-500">
            Biển số:{" "}
            <span className="text-slate-700 font-normal">50AĐ-767.72</span>
          </div>
          <div className="text-[12px] text-slate-500">
            Shipment ID:{" "}
            <span className="text-slate-700 font-normal">SHIP001234</span>
          </div>
          <div className="text-[12px] text-slate-500">
            Mã đơn hàng:{" "}
            <span className="text-slate-700 font-normal">DL04MP7045</span>
          </div>
        </div>
      </div>
      ...
      <div className="mt-3 grid grid-cols-2 gap-x-4 gap-y-1 text-[12px] leading-snug text-slate-600">
        <div>
          Trọng tải{" "}
          <span className="font-semibold text-slate-800">6.5 tấn</span>
        </div>
        <div className="text-right">
          Chiều rộng hàng{" "}
          <span className="font-semibold text-slate-800">4.8 mét</span>
        </div>
        <div>
          Thể tích hàng{" "}
          <span className="font-semibold text-slate-800">35,393 lít</span>
        </div>
        <div className="text-right">
          Chiều dài hàng{" "}
          <span className="font-semibold text-slate-800">11.7 mét</span>
        </div>
      </div>
    </div>
  );
