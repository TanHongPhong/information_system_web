...
export default function Header() {
  return (
    <header className="sticky top-0 z-10 shadow-sm">
      ...
      >
        {/* overlay tương đương ::after của .header-gradient */}
        <div
        ...
        <div className="flex items-center gap-2">
          <div className="p-2 rounded-lg bg-white/15 ring-1 ring-inset ring-white/10">
            <FeatherIcon
              name="truck"
              className="w-5 h-5 text-white drop-shadow-[0_1px_1px_rgba(0,0,0,.45)]"
            />
          </div>
          <div>
            ...
            <p className="text-xs/5 text-white/95 mt-0.5 drop-shadow-[0_1px_1px_rgba(0,0,0,.45)]">
