  ...
  return (
    <div className="fixed inset-0 z-[60]">
      ...
      <div className="relative z-[61] w-full h-full grid place-items-center p-4">
        <div className="w-full max-w-[960px] lg:max-w-[1040px] bg-white rounded-2xl shadow-soft border border-slate-200 overflow-hidden max-h-[90vh] flex flex-col animate-in" role="dialog" aria-modal="true" aria-labelledby="modal-title">
          {/* Header */}
