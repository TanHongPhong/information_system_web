          ...
          <div className="relative">
            ...
            <div className="px-5 md:px-6 py-3">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                <StatBox
                  label="Đơn hoàn tất (12 tháng)"
                  value={
                    company.stats?.orders12m?.toLocaleString("vi-VN") ?? "—"
                  }
                />
                <StatBox
                  label="Tỉ lệ đúng hẹn"
                  value={
                    company.stats?.ontimeRate != null
                      ? `${company.stats.ontimeRate}%`
                      : "—"
                  }
                  accent
                />
                <StatBox
                  label="Điểm phản hồi (CSAT)"
                  value={
                    company.stats?.csat != null
                      ? `${company.stats.csat}/5`
                      : "—"
                  }
                />
          ...
          <div className="p-5 md:p-6 overflow-auto">
            <div className="flex flex-wrap gap-2 text-sm mb-4">
              {badges.map((b) => (
                <span
                  key={b}
                  className="px-2.5 py-1 rounded-full bg-slate-50 ring-1 ring-slate-200"
                >
                  {b}
                </span>
              ))}
