...
export default function Styles() {
  return (
    <style>{`
      ...
      /* Shadows (đồng bộ HTML) */
      .shadow-soft{ box-shadow:0 12px 40px rgba(2,6,23,.08); }
      .shadow-blueglow{ box-shadow:0 10px 24px rgba(37,99,235,.32); }

      /* Ribbons + shine (đồng bộ HTML) */
      .bg-ribbon{ background-image:linear-gradient(90deg,#22d3ee,#60a5fa,#a78bfa,#f472b6,#f59e0b); background-size:200% 100%; }
