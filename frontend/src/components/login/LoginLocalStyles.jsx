...
export default function LoginLocalStyles() {
  return (
    <style>{`
      body { background:#fff; }
      ...
      .btn-blue{ background:linear-gradient(180deg,#3b82f6,#2563eb); color:#fff; box-shadow:0 6px 18px rgba(37,99,235,.35); }
      .btn-blue:hover{ filter:brightness(1.03); box-shadow:0 8px 24px rgba(37,99,235,.45); }

      .btn-green{ background:linear-gradient(180deg,#34d399,#10b981); color:#fff; box-shadow:0 6px 18px rgba(16,185,129,.35); }
      ...
      .bg-brand-badge{ background:linear-gradient(135deg,#1d4ed8,#1e40af); }
