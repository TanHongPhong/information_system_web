...
// Tập hợp icon dạng Feather (stroke 2px)
// Các icon này là SVG độc lập -> không cần feather.replace()
...
export function AlertTriangleIcon(props) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.7 3h16.96a2 2 0 0 0 1.7-3L13.71 3.86a2 2 0 0 0-3.42 0z" />
